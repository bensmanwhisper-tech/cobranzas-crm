    ...
    <div className="space-y-4" data-testid="recovery-panel">
      ...
      <div className="bg-[#101013] border border-white/5 rounded-xl p-5 relative overflow-hidden">
        ...
        <div className="flex items-start justify-between mb-4 relative">
          ...
          <div className="text-right">
            <div className="font-display font-bold text-5xl" style={{ color: "#E1FF00" }}>{rate}%</div>
        ...
        <div className="h-3 bg-white/5 rounded-full overflow-hidden relative">
          <div
            className="h-full bg-gradient-to-r from-emerald-400 via-emerald-300 to-[#E1FF00] transition-all duration-1000"
            style={{ width: `${pct}%` }}
          />
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="bg-[#101013] border border-white/5 rounded-xl p-5">
          <div className="text-[10px] uppercase tracking-[0.2em] text-zinc-500 mb-3">Cartera por estado</div>
        ...
        {/* SMS counter per country */}
        <div className="bg-[#101013] border border-white/5 rounded-xl p-5">
          <div className="flex items-center justify-between mb-3">
            <div className="text-[10px] uppercase tracking-[0.2em] text-zinc-500">SMS ✅ por país</div>
